...
export default {
  ...
  goods: {
    ...
    view_goodslist: {
      ...
      goods_weight: 'Warengewicht (Einheit: lb)',
      goods_w: 'Artikellänge (Einheit: in)',
      goods_d: 'Produktbreite (Einheit: in)',
      goods_h: 'Warenhöhe (Einheit: in)',
  ...
  warehouse: {
    ...
    view_binsize: {
      bin_size: 'Lagergröße',
      bin_size_w: 'Lagerlänge (Einheit: in)',
      bin_size_d: 'Lagerbreite (Einheit: in)',
      bin_size_h: 'Lagerhöhe (Einheit: in)',
      error1: 'Bitte Ortsnamen eingeben',
