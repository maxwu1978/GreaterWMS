...
export default {
  ...
  goods: {
    ...
    view_goodslist: {
      ...
      goods_weight: 'Peso de la mercancía (unidad: lb)',
      goods_w: 'Longitud del artículo (unidad: in)',
      goods_d: 'Ancho del producto (unidad: in)',
      goods_h: 'Altura de la mercancía (unidad: in)',
  ...
  warehouse: {
    ...
    view_binsize: {
      bin_size: 'Tamaño de existencias',
      bin_size_w: 'Longitud de stock (unidad: in)',
      bin_size_d: 'Ancho de stock (unidad: in)',
      bin_size_h: 'Altura de stock (unidad: in)',
