...
export default {
  ...
  releaseallorder: 'Release ready orders',
  ...
  operations_board: {
    ...
    eta_not_provided: 'Not Provided',
    eta_due_soon: 'Due Soon',
    eta_on_time: 'On Time',
    eta_overdue: 'Overdue',
    eta_arrived: 'Arrived',
    eta_completed: 'Completed',
    eta_cancelled: 'Cancelled',
    eta_due_in: 'Due in',
    eta_overdue_by: 'Overdue by',
    customer: 'Owner / Customer',
    customer_not_provided: 'Not Provided',
    type: 'Type',
    inbound: 'Inbound',
    receiving: 'Receiving',
    outbound: 'Outbound',
    ...
    location_hint: 'Target area for this step, not current inventory location',
    ...
    fullscreen_unavailable: 'Fullscreen is not supported by this browser',
    zoom_in: 'Zoom in',
    zoom_out: 'Zoom out',
    zoom_reset: 'Reset zoom',
    no_work: 'No active warehouse work',
    no_history: 'No processed work',
    completed: 'Completed',
    cancelled: 'Cancelled',
    status_completed: 'Completed',
    status_cancelled: 'Cancelled',
    status_pre_arrival: 'Pre Arrival',
    status_pending_arrival: 'Await Arrival',
    status_ready_to_unload: 'Ready Unload',
    status_awaiting_unloading_driver: 'Awaiting Unloading Driver',
    status_unloading: 'Unloading',
    status_receiving_review: 'Receiving Review',
    status_qc_review_required: 'QC Review',
    status_qc_partial_hold: 'QC Hold',
    status_repair_hold: 'Repair Hold',
    status_pack_list_review: 'Pack Review',
    status_ready_for_putaway: 'Ready Putaway',
    status_ready_for_putaway_partial: 'Ready Partial',
    status_receiving: 'Receiving',
    status_putaway: 'Putaway',
    status_qc_pending: 'QC Pending',
    status_qc_exception: 'QC Exception',
    status_putaway_pending: 'Putaway Pending',
    status_putaway_complete: 'Putaway Complete',
    status_closed: 'Closed',
    status_reconciliation_pending: 'Reconciliation Pending',
    status_awaiting_asn: 'Awaiting ASN',
    ...
    pack: 'Pack',
    ship: 'Ship',
    assign_unloading_driver: 'Assign Unloading Driver',
    assign_putaway_driver: 'Assign Putaway Driver',
    await_arrival: 'Await Arrival',
    reserve_stage: 'Reserve Stage',
    stage: 'Stage',
    storage: 'Storage',
    shipping: 'Shipping',
    dock: 'Dock'
  ...
  goods: {
    ...
    view_goodslist: {
      ...
      goods_weight: 'Goods Weight(Unit:lb)',
      goods_w: 'Goods Width(Unit:in)',
      goods_d: 'Goods Depth(Unit:in)',
      goods_h: 'Goods Height(Unit:in)',
  ...
  inbound: {
    ...
    view_asn: {
      ...
      sku_count: 'SKUs',
      sku_quantity: 'SKU / Qty',
      quantity: 'Planned / Received',
      planned_qty: 'Planned Qty',
      actual_qty: 'Received Qty',
      staging_bin: 'Staging',
      pack_list_status: 'Pack List',
      exception_qty: 'Exceptions',
      next_action: 'Next Step',
      pack_list_not_received: 'Not Received',
      pack_list_pending: 'Pending',
      pack_list_confirmed: 'Confirmed',
      precheck_ready: 'Ready for Receiving',
      precheck_no_pack_list: 'No Pack List',
      precheck_pack_list_pending: 'Pack List Pending',
      precheck_pack_list_mismatch: 'ASN / Pack List Mismatch',
      precheck_sn_incomplete: 'SN Check Pending',
      precheck_not_applicable: '—',
      exception_sn: 'SN Exception',
      exception_quantity: 'Qty Exception',
      exception_pack_list_review: 'Pack List Review',
      exception_not_checked: 'Not Checked',
      exception_none: 'No Exceptions',
      staging_unassigned: 'Not Assigned',
      staging_released: 'Released',
      qc_not_checked: 'Not Checked',
      qc_normal: 'Normal',
      confirm_arrival_staging: 'Confirm Arrival and Assign Staging',
      required_staging_locations: 'Required staging locations',
      confirm_arrival: 'Confirm Arrival',
      finish_unloading: 'Finish Unloading',
      record_receipt: 'Record Receipt',
      start_putaway: 'Putaway',
      goods_qty: 'ASN QTY',
  ...
  outbound: {
    ...
    pickstock: 'Ready to Pick',
    pickedstock: 'Picked',
    pickinglist: 'Picking List',
    shippedstock: 'In Transit',
    received: 'Delivered',
  ...
  warehouse: {
    ...
    view_binsize: {
      bin_size: 'Bin Size',
      bin_size_w: 'Bin Size Wide(Unit:in)',
      bin_size_d: 'Bin Size Depth(Unit:in)',
      bin_size_h: 'Bin Size Height(Unit:in)',
