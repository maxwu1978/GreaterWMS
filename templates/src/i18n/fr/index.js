...
export default {
  ...
  goods: {
    ...
    view_goodslist: {
      ...
      goods_weight: 'Poids de la marchandise (unité : lb)',
      goods_w: "'Longueur de l'article (unité : in)'",
      goods_d: 'Largeur du produit (unité : in)',
      goods_h: 'Hauteur de la marchandise (unité : in)',
  ...
  warehouse: {
    ...
    view_binsize: {
      bin_size: 'Taille du stock',
      bin_size_w: 'Longueur de stock (unité : in)',
      bin_size_d: 'Largeur du stock (unité : in)',
      bin_size_h: 'Hauteur du stock (unité : in)',
