...
TEMPLATES = ROOT / "templates" / "src"
SHARED_TABLE = TEMPLATES / "components" / "GreaterWmsOperationsTable.vue"
OPERATIONAL_PAGES = {
    "Dashboard": TEMPLATES / "pages" / "dashboard" / "operationsBoard.vue",
    "Mail2Task": TEMPLATES / "pages" / "sourceIntake.vue",
}
