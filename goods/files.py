...
def cn_data_header():
    return dict([
        ...
        ('goods_specs', u'商品规格'),
        ('goods_origin', u'商品产地'),
        ('measurement_unit', u'尺寸重量单位'),
        ('customer_sku', u'客户SKU'),
        ('source_evidence_id', u'来源证据ID'),
        ('source_note', u'来源备注'),
        ('goods_cost', u'商品成本'),
        ('goods_price', u'商品价格'),
        ('creater', u'创建人'),
...
def en_data_header():
    return dict([
        ...
        ('measurement_unit', u'Measurement Unit'),
        ('customer_sku', u'Customer SKU'),
        ('source_evidence_id', u'Source Evidence ID'),
        ('source_note', u'Source Note'),
