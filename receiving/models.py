...
class ReceivingRecord(models.Model):
    ...
    putaway_driver = models.CharField(max_length=255, blank=True, default='')
    putaway_assigned_by = models.CharField(max_length=255, blank=True, default='')
    putaway_assigned_at = models.DateTimeField(blank=True, null=True)
...
class ReceivingDetail(models.Model):
    ...
    asn_expected_qty = models.PositiveIntegerField(default=0)
    inventory_qty_applied = models.PositiveIntegerField(default=0)
    asn_stock_released = models.BooleanField(default=False)
